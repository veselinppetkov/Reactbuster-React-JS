        ...
        <div className="row">
          <div className="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 order-4 order-md-1 order-lg-4 order-xl-1">
            {/* <div className="footer__social">
              ...
              <Link
                to="https://www.instagram.com/volkov_des1gn/"
                target="_blank"
              >
                <svg
                  width="30"
          ...
          <div className="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
            <div className="row">
              ...
              <div className="col-6">
                <div className="footer__nav">
                  <Link to="live.html">Live TV</Link>
                  <Link to="live.html">Live News</Link>
                  <Link to="live.html">Live Sports</Link>
                  <Link to="live.html">Streaming Library</Link>
                </div>
              </div>

              <div className="col-6">
                <div className="footer__nav">
                  <Link to="category.html">TV Shows</Link>
                  <Link to="category.html">Movies</Link>
                  <Link to="category.html">Kids</Link>
                  <Link to="category.html">Collections</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
            ...
            <div className="footer__nav">
              <Link to="privacy.html">Account & Billing</Link>
              <Link to="privacy.html">Plans & Pricing</Link>
              <Link to="privacy.html">Supported devices</Link>
              <Link to="privacy.html">Accessibility</Link>
            </div>
          </div>*/}
        </div>
          ...
          <div className="col-12">
            <div className="footer__content">
              {/* <div className="footer__links">
                ...
                <Link to="privacy.html">Terms and conditions</Link>
              </div> */}
              <small className="footer__copyright">
                Template created by <Link to="#">Dmitry Volkov &copy;</Link>
              </small>
